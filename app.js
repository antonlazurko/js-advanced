(function () {
	...
	*/
	...
	class Search extends CustomComponent {
	    constructor(appState) {
	...
	class BookCard extends CustomComponent {
	...
	class BookList extends CustomComponent {
	...
	function getFavoritesFromStorageAndSet(appState) {
	...
	function setFavoritesToStorage(appState) {
